...
def start_client(dataset: DATASET) -> None:
    ...
    # Load and compile a Torch model for CIFAR-10
    net = SimpleNet().to(DEVICE)

    # Unpack the CIFAR-10 dataset partition
    trainloader, testloader = dataset
    print("Trainloader is:", trainloader)
    print("Testloader is:", testloader)
...
if __name__ == "__main__":
    ...
    run_simulation(num_rounds=10, num_clients=4, fraction_fit=0.5)
